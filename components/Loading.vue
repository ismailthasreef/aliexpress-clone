...
<template>
    <div class="fixed bg-black bg-opacity-40 inset-0 w-full flex items-center justify-center h-[100vh] overflow-hidden">
        <div class="p-3 rounded-md bg-black bg-opcaity-20">
